    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-cyan-50 via-white to-teal-50 flex items-center justify-center px-4">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-3">Không tìm thấy lịch hẹn</h2>
    ...
    <div className="min-h-screen bg-gradient-to-br from-cyan-50 via-white to-teal-50 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Thông Tin Lịch Hẹn</h1>
          <p className="text-gray-600">Theo dõi trạng thái và chi tiết lịch khám của bạn</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="p-8 space-y-6">
            ...
            <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-xl">
              ...
              <div className="flex-1">
                ...
                <p className="text-lg font-semibold text-gray-900">{formatDateTime(appointment.appointmentTime)}</p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-lg font-semibold text-gray-900">{appointment.phone}</p>
                </div>
              </div>
            </div>
            ...
            {appointment.email && (
              <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-lg font-semibold text-gray-900">{appointment.email}</p>
                </div>
              </div>
            )}
            ...
            {appointment.services && appointment.services.length > 0 && (
              <div className="p-4 bg-gray-50 rounded-xl">
                <p className="text-sm text-gray-600 mb-3 font-semibold">Dịch vụ đăng ký</p>
            ...
            {appointment.confirmedBy && (
              <div className="p-4 bg-green-50 border border-green-200 rounded-xl">
                <p className="text-sm text-green-700 mb-1">Được xác nhận bởi</p>
                <p className="text-lg font-semibold text-green-900">{appointment.confirmedBy}</p>
          ...
          <div className="bg-gray-50 px-8 py-6 border-t border-gray-200">
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                onClick={() => navigate('/')}
                className="flex-1 bg-white border-2 border-gray-300 hover:border-gray-400 text-gray-700 py-3 rounded-lg font-semibold transition-colors"
              >
                Về trang chủ
              </button>
              <button
