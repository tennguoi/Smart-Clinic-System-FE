...
export default function NewsPage() {
  ...
  const loadArticles = async () => {
    ...
    // ƯU TIÊN KẾT HỢP KHI CẢ 2 ĐỀU CÓ
    if (keyword.trim() && category) {
      ...
      // Lưu ý: endpoint /search hiện tại tìm toàn bộ → nhưng khi có category, chúng ta sẽ lọc thêm ở frontend nếu cần
      // Tuy nhiên để chính xác hơn, ta vẫn gọi /search trước (vì backend tìm full-text tốt hơn)
      // Sau đó nếu cần sẽ lọc lại ở frontend (rất nhẹ)
    }
