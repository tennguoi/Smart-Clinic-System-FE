...
const DoctorPatientList = ({ onCreateMedicalRecord, onViewHistory }) => {
  ...
  const handleSaveMedicalRecord = (savedRecord) => {
    ...
    <div className="bg-white rounded-lg shadow">
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-3">
                      ...
                      <div className="text-xs text-gray-500">
                        {patient.identityCard && `CCCD: ${patient.identityCard}`}
                      </div>
                    </div>
                  </div>
                </td>
                  ...
                  <div className="max-w-xs">
                    {patient.medicalHistory && (
                      <div className="text-xs text-gray-600 mb-1">
                        <strong>Tiền sử:</strong> {patient.medicalHistory.length > 50 
                    ...
                    {patient.allergies && (
                      <div className="text-xs text-orange-600">
                        <strong>Dị ứng:</strong> {patient.allergies.length > 50 
                          ? `${patient.allergies.substring(0, 50)}...` 
                          : patient.allergies}
                      </div>
                    )}
      ...
      {showDetail && selectedPatient && (
        <PatientDetail
          ...
          onEdit={() => {}} // Bác sĩ không được phép edit thông tin bệnh nhân
        />
      )}
      ...
      {showMedicalForm && selectedPatient && (
        <MedicalRecordForm
          patient={selectedPatient}
          onClose={handleCloseMedicalForm}
