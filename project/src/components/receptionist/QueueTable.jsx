      ...
      <table className="min-w-full divide-y divide-gray-200">
        <thead className="bg-gray-50">
          <tr>
            ...
            <th className="px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Phòng khám</th>
                ...
                <td className="px-4 py-3 text-sm">
                  {q.roomName ? (
                    <div className="font-medium text-green-700">
                      {q.roomName}
                      {q.doctorName && <div className="text-xs text-gray-600">BS: {q.doctorName}</div>}
                    </div>
                  ) : (
                    <span className="text-gray-400 italic">Đang phân phòng...</span>
                  )}
                </td>
                <td className="px-4 py-3 text-sm">
