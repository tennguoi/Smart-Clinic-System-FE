...
export default function CoreValues() {
  ...
  return (
    <section className="py-12 bg-gradient-to-b from-white to-cyan-50/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {values.map((value, index) => (
            <div
              key={index}
              className="group text-center p-8 rounded-2xl bg-white hover:bg-cyan-50 transition-all duration-300 shadow-md hover:shadow-2xl hover:shadow-cyan-500/20 border border-gray-100 hover:border-cyan-200 transform hover:-translate-y-2"
            >
              <div
