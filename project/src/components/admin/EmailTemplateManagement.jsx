  ...
  return (
    <>
      ...
      >
        ...
        >
          Tùy chỉnh nội dung email gửi cho khách hàng. Sử dụng các nút placeholder để chèn dữ liệu
          động như <code className="bg-gray-200 dark:bg-gray-700 px-2 py-1 rounded">{'{{patientName}}'}</code>.
        </p>
